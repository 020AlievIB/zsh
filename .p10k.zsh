# Generated by Powerlevel10k configuration wizard on 2024-02-11 at 22:38 MSK.
...
# round separators, round heads, sharp tails, 2 lines, disconnected, full frame, sparse,
...
() {
  ...
  typeset -g POWERLEVEL9K_SHORTEN_STRATEGY=3
  ...
  typeset -g POWERLEVEL9K_GOOGLE_APP_CRED_DEFAULT_COxNTENT_EXPANSION='${P9K_GOOGLE_APP_CRED_PROJECT_ID//\%/%%}'
